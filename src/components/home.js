    ...
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.text}>
          ...
          experience of being untethered to technology - particularly feed-based
          social media.
          <br />
          <br />
          ...
          Eurydice would follow Orpheus - on the rule that if Orpheus were to
          look back on his way out of the underworld, he would lose her. Just as
          Orpheus was heading back to earth, out of anxiety that Eurydice wasn't
          there, Orpheus looked back - and saw Eurydice engulfed and lost
          forever.
          <br />
          <br />
          Our hope is that once you are freed of the distraction of technology,
          can live in more present, meaningful, and happy ways.
          <br />
          <br />
