      ...
      <div className={styles.content}>
        ...
        <Row className="mx-auto">
          <ul className={styles.list}>
            <li>
              <p>
                <em>Yes?</em>_ Let's learn more about your relationship with
                technology.
              </p>
            </li>
            <li>
              <p>
                <em>Maybe?</em>_ We often find ourselves here. Try the
                assessment and see if you need this.
              </p>
            </li>
            <li>
              <p>
                <em>No?</em>_ Great. You may be interested in the rest of the
